...
<head>
    ...
    <style>
        ...
        .amount-value { font-size: 18px; font-weight: 700; color: #2d5a27; }
        ...
        .summary-bar strong { color: #2d5a27; font-size: 15px; }
...
<div class="page-wrapper">
    ...
    <%
        ...
        long reservedCount  = reservations.stream().filter(r -> "reserved".equalsIgnoreCase(r.getStatus())).count();
        long cancelledCount = reservations.stream().filter(r -> "cancelled".equalsIgnoreCase(r.getStatus())).count();
    %>
    ...
    <% } else {
        for (ReservationDTO r : reservations) {
            ...
            switch (status.toLowerCase()) {
                case "reserved":
                    badgeClass = "badge-reserved"; badgeLabel = "✅ 예약 완료"; break;
                case "cancelled":
                    badgeClass = "badge-cancelled"; badgeLabel = "❌ 취소됨"; break;
                case "completed":
                    badgeClass = "badge-completed"; badgeLabel = "🏁 이용 완료"; break;
                default:
                    badgeClass = "badge-default"; badgeLabel = status;
            }
