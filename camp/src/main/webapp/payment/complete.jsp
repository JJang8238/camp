...
<div class="complete-wrap">
    ...
    <div class="complete-info">
        <p>캠핑장: <strong><%=orderName%></strong></p>
        <p>결제 금액: <strong>₩ <%=formattedAmount%>원</strong></p>
    ...
    <div class="btn-group-complete">
        <a href="<%=ctx%>/main.jsp" class="btn-go-main">메인으로</a>
        <a href="<%=ctx%>/campList" class="btn-go-camp">다른 캠핑장 보기</a>
    </div>
</div>
